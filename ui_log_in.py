...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonCreate = QPushButton(self.centralwidget)
        self.buttonCreate.setObjectName(u"buttonCreate")
        self.buttonCreate.setGeometry(QRect(40, 320, 260, 27))
        self.buttonCreate.setMinimumSize(QSize(0, 27))
        font = QFont()
        font.setFamilies([u"Roboto"])
        font.setPointSize(8)
        self.buttonCreate.setFont(font)
        self.buttonCreate.setCursor(QCursor(Qt.PointingHandCursor))
        self.buttonCreate.setFlat(False)
        self.groupBoxMain = QGroupBox(self.centralwidget)
        self.groupBoxMain.setObjectName(u"groupBoxMain")
        self.groupBoxMain.setGeometry(QRect(40, 130, 261, 91))
        font1 = QFont()
        ...
        self.groupBoxConfirm.setGeometry(QRect(40, 230, 260, 71))
        ...
        self.buttonCreate.setDefault(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttonCreate.setText(QCoreApplication.translate("MainWindow", u"Create", None))
